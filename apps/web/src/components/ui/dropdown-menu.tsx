...
import { KeyboardShortcut } from '../KeyboardShortcut/KeybooardShortcut';
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn('px-2 py-1.5 text-sm font-thin', inset && 'pl-8', className)}
    {...props}
  />
));
...
const DropdownMenuShortcut = ({ className, ...props }: React.ComponentPropsWithoutRef<typeof KeyboardShortcut>) => {
